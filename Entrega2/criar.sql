...
CREATE TABLE Sponsor (
    ...
    email TEXT CONSTRAINT unique_Sponsor_email UNIQUE CONSTRAINT null_Sponsor_email NOT NULL,
...
CREATE TABLE ChessClub (
    ...
    adress TEXT CONSTRAINT unique_ChessClub_adress UNIQUE CONSTRAINT null_ChessClub_adress NOT NULL,
